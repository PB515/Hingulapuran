...
| [QUOTES-AND-MANTRAS.md](QUOTES-AND-MANTRAS.md) | Mantras, the vow, key verses. |
| [GENEALOGY.md](GENEALOGY.md) | Lineage trees (Mermaid). Styled SVG: [`/public/genealogy.svg`](../public/genealogy.svg). |

## Art / scene production
| Doc | What it is |
|---|---|
| [SCENE-PROMPTS.md](SCENE-PROMPTS.md) | The scene-reel prompts (the conservation engine). |
